...
vim.keymap.set('n', '<leader>i', "<C-k><C-l><C-l><C-l>:Floaterms<CR>")
-- Open new floaterm with hardcoded (iterm) name
vim.keymap.set('n', '<leader>q', ":FloatermNew --wintype=vsplit --height=1.0 --width=0.33 --title=iterm --position=right --autoclose=0<CR>")
-- Allow specifying the name of the floaterm before opening
vim.keymap.set('n', '<leader>qn', ":FloatermNew --wintype=vsplit --height=1.0 --width=0.33 --position=right --autoclose=0 --title=")
